...
class MouseController:
    def __init__(self):
        ...
        # These constants control how fast the cursor moves.
        # Adjust these to suit your application.
        self.base_speed = 4.0      # Minimum movement speed (in pixels per update)
        self.max_speed = 20.0      # Maximum movement speed (in pixels per update)
        self.exp_factor = 2.0      # Exponential acceleration factor
        
        # Vertical sensitivity multipliers:
        # For vertical (y) movement, we apply different multipliers:
        #   - up_multiplier: When moving upward (cursor moves up), use a smaller multiplier for fine control.
        #   - down_multiplier: When moving downward, use a larger multiplier since head-down movement is less natural.
        self.up_multiplier = 1.5   # Slightly more sensitive for upward movement
    ...
    def update(self, angles):
        ...
        if len(self.yaw_history) == self.smooth_window:
            ...
            # Apply different sensitivity multipliers for upward and downward movement.
            if raw_y_speed < 0:
